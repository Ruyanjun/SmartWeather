...
import com.roydon.smartweather.adapter.CityAdapter;
import com.roydon.smartweather.adapter.ProvinceAdapter;
...
public class SelectCityActivity extends AppCompatActivity {
    ...
    private RecyclerView rvCountryside;
    ...
    private void searchEvent() {
        query = (AutoCompleteTextView) findViewById(R.id.edit_query);//绑定组件
